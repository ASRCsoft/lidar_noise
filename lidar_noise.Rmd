...
```{python, engine.path="/usr/bin/python3", fig.cap='Representative samples of data generated by wind and noise states', fig.align='center', fig.env="figure*"}
...
```{python, engine.path="/usr/bin/python3", fig.cap='RWS data and results', fig.align='center', fig.width=3.17, fig.env="figure*"}
# add the current folder to the import path
import sys
sys.path.append('.')
